              ...
              <ul role="radiogroup">
                ...
                <li class="mb-2">
                  <label
                    ...
                    <input name="choose_networks" type="radio" checked
                    ...
                    <div class="text-left flex-1">
                      <p class="font-medium text-blue-500 dark:text-blue-400 text-sm">Plasm Network (Mainnet)</p>
                    </div>
                  </label>
                </li>
                ...
                <li class="mb-2">
                  <label
                    ...
                    <input name="choose_networks" type="radio"
                        class="appearance-none border-2 border-gray-300 dark:border-darkGray-600 rounded-full focus:ring-blue-500 h-4 w-4 mr-3 focus:outline-none bg-white dark:bg-darkGray-900 checked:border-4 checked:border-blue-500">
                    <div class="text-left flex-1">
                      <p class="font-medium text-gray-500 dark:text-darkGray-400 group-hover:text-gray-700 dark:group-hover:text-darkGray-300 text-sm">
                        Dusty Network (Testnet)</p>
                    </div>
                  </label>
                </li>
                  ...
                  <label
                    ...
                    <div class="text-left flex-1">
                      <p
                        ...
                        Custom Network</p>
                      <input type="text" placeholder="IP Address / Domain"
