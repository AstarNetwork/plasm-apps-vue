            ...
            <fieldset>
              <ul role="radiogroup" class="grid grid-cols-3 gap-2">
                ...
                <li>
                  ...
                  >
                    <div
                      class="h-10 w-10 rounded-full overflow-hidden mx-auto mb-2"
                    >
                      <img
                        src="@/assets/img/ACA.96bf6b59.svg"
                        class="h-full w-full"
                      />
                    </div>
                    <div>
                      <p
                        class="text-blue-500 dark:text-blue-400 font-bold text-lg leading-tight"
                      >
                        ACA
                      </p>
                      <p class="text-gray-500 dark:text-darkGray-400 text-xs">
                        Acala
                      </p>
                    </div>
                    <div
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p
                        class="text-gray-500 dark:text-darkGray-500 dark:group-hover:text-darkGray-400 text-xs"
                      >
                        Acala
                      </p>
                    </div>
